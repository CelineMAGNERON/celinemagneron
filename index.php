    ...
    <main class="container-fluid">
        ...
        <section class="row" id="who">
            <div class="col-12 who-content">
                ...
                <hr class="separator">
                <div class="row">
                    <span>Enfant des années fin 90, depuis la campagne où j'ai grandi, j'étais insatiablement attirée par cette toile naissante qu'est le World Wide Web. Pourquoi s'occuper d'un Tamagochi alors qu'on peut s'investir à convaincre ses parents à équiper la maison d'un ordinateur (avec une connexion évidemment, merci AOL !) ?</span>
                    <span>Plus tard, après 8 ans à évoluer dans le secteur professionnel du social, il est temps de revenir à ce centre d'intérêt de cette drôlesse (pour parler poitevin) 'millenniale'.</span>
                    <span>Mon projet professionnel est de devenir développeuse full-stack JavaScript, tout en sensibilisant à l’accessibilité du web pour tout internaute, et me spécialiser dans l’éco-conception des projets afin de minimiser l’impact du web sur l’environnement.</span>
                    <span>J'ai débuté par une formation intensive à l'ENI Ecole Informatique de niveau 5. Cependant afin d’optimiser la qualité de mon parcours auprès de professionnels, j’ai intègré le Bachelor Développeuse web en alternance à l’ICSSA de Niort et en partenariat avec 3iL Ingénieurs de Limoges, pour une durée d’un an, en septembre 2020 :
                    ...
                    <span>Je suis à la recherche d'une structure dynamique et tournée vers des technologies toujours actualisées dans laquelle investir mes compétences et ma créativité sur un poste de développeuse JavaScript, et restant ouverte aux postes J2EE :)</span>
            ...
            <div class="col-12 projets-content">
                ...
                <div class="row">
                    <article class="col-xs-12 col-sm-12 col-md-4 col-lg4">
                        ...
                        <p>Réalisation d’un site interactif autour de textes philosophiques, développé avec mySQL, PHP, HTML5/CSS3 et JavaScript.</p>
                    </article>
                    <article class="col-xs-12 col-sm-12 col-md-4 col-lg4">
                        ...
                        <h5>Shiatsu Niort</h5>
                        <p>Reprise de site sur WordPress, injection de CSS, en attendant la version from scratch</p>
                    </article>
                    <article class="col-xs-12 col-sm-12 col-md-4 col-lg4">
                        ...
                        <p>Réalisation en JavaScript et une dose de comics'geekerie</p>
                    </article>
                </div>
            </div>
        </section>
        ...
        <section class="row" id="extrapro">
            <div class="col-12 extrapro-content">
                ...
                <hr class="separator">
                <div class="row">
                    <article class="col-xs-12 col-sm-12 col-md-3 col-lg3">
                        <h5>Association Trisomie 21 Deux Sèvres (depuis avril 2014)</h5>
                        <p>Vice présidente, référente communication</p>
                        <a class="" href="https://www.facebook.com/trisomie21.79" rel="" target="_blank">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-3 col-lg3">
                        ...
                        <a class="" href="https://www.lanouvellerepublique.fr/deux-sevres/marie-une-vie-devouee-aux-animaux-sauvages" rel="" target="_blank">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-3 col-lg3">
                        ...
                        <a class="" href="https://www.croix-rouge.fr/Nos-actions/Action-sociale/Lutte-contre-l-exclusion/Samu-social" rel="" target="_blank">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-3 col-lg3">
                        ...
                        <a class="col-12" href="https://www.mucomnisports.fr/" rel="" target="_blank">
